...
f = [0.2 0.25]; % vector con frecuencias l�mites de bandas
...
% Estima orden O requerido para el filtro, y los par�metros
% fo, ao y w, los cuales se requieren para el dise�o
